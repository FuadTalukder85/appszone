...
const Experience = () => {
  return (
    ...
    >
      <h1 className="text-[40px]">Work Experience</h1>
      <div className="grid grid-cols-2 gap-5 mt-10">
        {data?.map((dt) => (
          <div className="flex gap-4 items-center ps-5 pr-28 py-5 border-t-4 border-[#4F228D] rounded-2xl bg-[linear-gradient(to_right,#130428,#251043,#38126D,#261045,#190634)]">
            <img src={dt.img} alt="" />
            <div>
              <h2 className="font-semibold text-2xl">{dt.title}</h2>
              <p className="font-medium text-[8px]">{dt.description}</p>
